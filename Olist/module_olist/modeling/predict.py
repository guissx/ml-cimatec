"""Aplicação do modelo treinado a pedidos novos."""
...
def predict(data: pd.DataFrame, artefato: dict | None = None) -> pd.DataFrame:
    ...
    Args:
        data (pd.DataFrame): Pedidos a prever, contendo as colunas de features.
    ...
    # Reordena as colunas conforme o treino: o pipeline seleciona por nome, mas
    # manter a ordem evita surpresas caso a base de entrada traga extras.
